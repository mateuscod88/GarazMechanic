...
class OwnerDetailsDialogBox extends React.Component {
    constructor(props) {
        super(props);
...
OwnerDetailsDialogBox.propTypes = {
    classes: PropTypes.object.isRequired,
    theme: PropTypes.object.isRequired,
};
export default withStyles(styles, { withTheme: true })(OwnerDetailsDialogBox);